...
export const reviewSchema = z.object({
  rating: z.coerce.number().int().min(1, "Choose a rating. · একটি রেটিং নির্বাচন করুন।").max(5, "Choose a rating. · একটি রেটিং নির্বাচন করুন।"),
  reviewText: z.string().trim().min(3, "Please write at least 3 characters. · কমপক্ষে ৩টি অক্ষর লিখুন।").max(1000, "Keep your review under 1,000 characters. · রিভিউটি ১,০০০ অক্ষরের মধ্যে রাখুন।"),
